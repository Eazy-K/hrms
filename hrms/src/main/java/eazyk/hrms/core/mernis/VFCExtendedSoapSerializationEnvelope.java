...
public class VFCExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(VFCDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new VFCStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static VFCDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static VFCDateTimeConverter dateTimeConverter = new VFCStandardDateTimeConverter();

    public VFCExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public VFCExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new VFCMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=VFCHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,VFCExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=VFCHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
